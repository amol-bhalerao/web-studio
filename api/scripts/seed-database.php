    ...
    if ($n === 0) {
        $defaults = [
            'hero' => [
                ...
                'subtitle' => 'Excellence in teaching, research, and community engagement.',
                'tagline' => 'Affiliated institution · NAAC accredited · Learner-centered campus',
                'image_url' => '',
                'primary_cta_label' => 'About the college',
                'primary_cta_href' => '/p/about',
                'secondary_cta_label' => 'News & events',
                'secondary_cta_href' => '/p/news-events',
                'stats' => [
                    ['label' => 'Academic programs', 'value' => '24+'],
            ...
            'sections' => [
                [
                    'id' => 'intro-mission',
                    'heading' => 'Our mission',
                    'subheading' => 'Education that empowers',
                    'body_html' => '<p>We prepare students for careers and civic life through rigorous academics, mentoring, and hands-on learning.</p>',
                    'variant' => 'default',
                ],
                [
                    'id' => 'programs-spotlight',
                    'heading' => 'Programs & departments',
                    'subheading' => 'Undergraduate and postgraduate pathways',
                    'body_html' => '<p>Explore science, arts, commerce, and professional courses. Visit site pages or contact admissions.</p>',
                    'variant' => 'muted',
                ],
                [
                    'id' => 'campus-life',
                    'heading' => 'Campus life',
                    'subheading' => 'Beyond the classroom',
                    'body_html' => '<p>Sports, cultural events, and student councils build leadership. Follow News & events for updates.</p>',
                    'variant' => 'accent',
                ],
            ],
            'show_latest_posts' => true,
            'latest_posts_heading' => 'Campus news & stories',
            'latest_posts_intro' => 'Updates from departments, student achievements, and announcements.',
        ];
